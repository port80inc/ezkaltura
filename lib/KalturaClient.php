...
class KalturaSessionService extends KalturaServiceBase
{
	...
	function start($secret, $userId = "", $type = 0, $partnerId = -1, $expiry = 86400, $privileges = null)
	{
		...
		if (!$this->client->throwExceptionIfError($resultObject) ) {
            return false;
        }
		if (!$this->client->validateObjectType($resultObject, "string") ) {
            return false;
        }
		return $resultObject;
	}
...
class KalturaPartnerService extends KalturaServiceBase
{
	...
	function getSecrets($partnerId, $adminEmail, $cmsPassword)
	{
		...
		if (!$this->client->validateObjectType($resultObject, "KalturaPartner") ) {
            return false;
        }
		return $resultObject;
	}
